...
public class ControllerAuthor
{
	...
	DTOAuthor findByID(@PathVariable final String id)
	{
		...
		List<DTOAddress> collect = author.getAddresses().stream().map(a -> new DTOAddress(a.getAddress(), a.getAddress2(), 
			a.getZip(), a.getCity(), a.getCountry())).collect(Collectors.toList());
